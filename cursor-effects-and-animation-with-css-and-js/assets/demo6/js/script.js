...
function handleMouseMove(event) {
  var cursor_top = event.pageY - (cursor.clientHeight / 1);
  var cursor_left = event.pageX - (cursor.clientWidth / 1);
  var circle_top = event.pageY - (circle.clientHeight / 1);
  var circle_left = event.pageX - (circle.clientWidth / 1);
